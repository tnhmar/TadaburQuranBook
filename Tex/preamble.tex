...
%% The quran package may or may not define \qurantextfont depending on
%% the version. Use \providecommand so we define it if missing, and
%% then override it at document start to use our \quranfont.
\providecommand{\qurantextfont}{}
